...
import { Etudiant } from "../models/user.model"
...
getEtudiantsByClassGroup(groupId: number): Observable<Etudiant[]> {
  return this.http.get<Etudiant[]>(`${this.baseUrl}/etudiants/classGroup/${groupId}`);
}
